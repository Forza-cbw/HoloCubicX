...
ImuAction *IMU::getAction(void)
{
    ...
    {
        if (tmp_info.v_ay < -200)
        {
            tmp_info.active = ACTIVE_TYPE::TURN_LEFT;
        }
        else if (tmp_info.v_ay > 600)
        {
