...
static int anniversary_init(AppController *sys)
{
    ...
    log_i("anniversary init successful\n");
    return 0;
}
                                ...
                                const ImuAction *act_info)
{
    ...
    // log_i("%d %d %d %d", cur_target->tm_year,  cur_target->tm_mon,  cur_target->tm_mday,  cur_target->tm_wday);
    // log_i(F(""));
    // log_i("%d %d %d %d", cfg_data.target_date[run_data->cur_anniversary].tm_year,  cfg_data.target_date[run_data->cur_anniversary].tm_mon,  cfg_data.target_date[run_data->cur_anniversary].tm_mday,  cfg_data.target_date[run_data->cur_anniversary].tm_wday);
    // log_i(F(""));
    // log_i(F(cfg_data.event_name[run_data->cur_anniversary].c_str()));
